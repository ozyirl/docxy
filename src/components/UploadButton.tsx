                ...
                <div {...getRootProps()} className="border h-64 m-4 border-dashed border-gray-300 rounded-lg">
                    <div className="flex items-center justify-center h-full w-full">
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            ...
                            <div className="flex flex-col items-center jus pt-5 pb-6 ">
                                <Cloud className="h-6 w-6 text-stone-500 mb-2"/>
                            ...
                            {acceptedFiles && acceptedFiles[0]?(
                                <div className="mx-w-xs bg-white flex items-center rounded-md overflow-hidden outline outline-[1px] outline-stone-200 divide-x divide-stone-200">
